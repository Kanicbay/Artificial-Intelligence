...
public class Cliente implements Serializable{
    ...
    public String toString() {
        return "Cliente{" + "nombre=" + nombre + ", apellido=" + apellido + ", direccion=" + direccion + ", telefono=" + telefono + ", correo=" + correo + ", ciudad=" + ciudad + ", pais=" + pais + ", id=" + id + ", idVendedor=" + idVendedor + ", zipcode=" + zipcode + ", plazo=" + plazo + ", monto=" + monto + '}';
    }
